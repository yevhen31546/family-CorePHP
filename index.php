                ...
                <div class="container">
                  ...
                  <!--  <ul class="header--topbar-social nav float--left hidden-xs">
                    ...
                    <ul class="header--topbar-links nav ff--primary float--right">
                        <li>
                            <a href="coming-soon.html" title="Cart" data-toggle="tooltip" data-placement="bottom">
                ...
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <div class="header--navbar-logo navbar-brand">
                            <a href="index.php">
                                <img src="img/blacklogosm.png" class="normal" alt="">
                                <img src="img/whitelogosm.png" class="sticky" alt="">
                            </a>
                        </div>
                    ...
                    <div id="headerNav" class="navbar-collapse collapse float--right">
                        ...
                        <ul class="header--nav-links style--1 nav ff--primary">
                            <li><a href="members/home.php"><span>Member Login</span></a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
									...
									<li><a href="#group">Most Popular Groups</a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="coming-soon.html">Cart</a></li>
                                    <li><a href="coming-soon.html">Checkout</a></li>
                                </ul>
                            </li>
